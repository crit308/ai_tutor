...
An intelligent tutoring system that uses OpenAI's GPT models to provide personalized learning experiences.

## Features

- Interactive web interface for easy interaction
- Personalized study plans based on learning objectives
...
```bash
git clone https://github.com/crit308/ai_tutor.git
cd ai_tutor
```
...
Run the tutor in command line mode:
```bash
python run_tutor.py
```
...
- `ai_tutor/` - Core AI tutor implementation
  - `agents/` - Specialized AI agents (planner, teacher, quiz)
  - `tools/` - Utility tools for document processing and user management
- `templates/` - HTML templates for the web interface
- `ai_tutor_data/` - User data and progress storage
